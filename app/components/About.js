    ...
    >
      <div className="max-w-4xl mx-auto w-full">
        ...
        <motion.div
          ...
          className="space-y-6 md:space-y-8 text-base md:text-lg leading-loose md:leading-relaxed max-w-3xl mx-auto"
          style={{ color: "var(--text-secondary)" }}
        >
          <p className="text-center md:text-left">
            <span
              className="md:first-letter:text-5xl md:first-letter:font-playfair md:first-letter:mr-1 md:first-letter:float-left"
              style={{ color: "var(--accent-gold)" }}
            >
              I
            </span>{" "}
